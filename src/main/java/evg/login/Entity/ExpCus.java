...
@XmlRootElement
@NamedQueries({
      @NamedQuery(name="ExpCus.findAll",  query="SELECT e FROM ExpCus e")
    , @NamedQuery(name="ExpCus.findById", query="SELECT c FROM ExpCus c WHERE c.id = :id")
})
    
public class ExpCus implements Serializable {
	...
	@Column(name="ID_ESFL")
	private BigDecimal idEsfl;

	@Column(name="ID_ESFL_QR")
	private BigDecimal idEsflQr;
	...
	public BigDecimal getIdEsfl() {
		return this.idEsfl;
	}

	public void setIdEsfl(BigDecimal idEsfl) {
		this.idEsfl = idEsfl;
	}

	public BigDecimal getIdEsflQr() {
		return this.idEsflQr;
	}

	public void setIdEsflQr(BigDecimal idEsflQr) {
		this.idEsflQr = idEsflQr;
	}
